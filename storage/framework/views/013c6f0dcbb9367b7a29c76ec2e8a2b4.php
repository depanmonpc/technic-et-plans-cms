...
<?php $__env->startSection('title', 'Courtage travaux - Technic & Plans'); ?>
<?php $__env->startSection('description', "Découvrez notre service de courtage travaux : nous vous aidons à sélectionner les meilleurs artisans, obtenir les meilleurs devis et réaliser vos projets en toute sérénité."); ?>

<?php $__env->startSection('content'); ?>
    <!-- Entête -->
    <div class="entete">
        <img src="<?php echo e(asset('asset/img/entete-courtage-travaux.jpg')); ?>" alt="Un projet maîtrisé c'est du temps de gagné">
    </div>
        ...
        <div class="content content-courtage">
            ...
            <div class="courtage-container">
                <div class="courtage-container-item">
                    <img src="<?php echo e(asset('asset/img/icon-1.png')); ?>" alt="PREMIÈRE PHASE">
                ...
                <div class="courtage-container-item">
                    <img src="<?php echo e(asset('asset/img/icon-2.png')); ?>" alt="QUATRIÈME PHASE">
                ...
                <div class="courtage-container-item">
                    <img src="<?php echo e(asset('asset/img/icon-3.png')); ?>" alt="DEUXIÈME PHASE">
                ...
                <div class="courtage-container-item">
                    <img src="<?php echo e(asset('asset/img/icon-4.png')); ?>" alt="CINQUIÈME PHASE">
                ...
                <div class="courtage-container-item">
                    <img src="<?php echo e(asset('asset/img/icon-5.png')); ?>" alt="TROISIÈME PHASE">
                ...
                <div class="courtage-container-item">
                    <img src="<?php echo e(asset('asset/img/icon-6.png')); ?>" alt="SIXIÈME PHASE">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="courtage-btn">NOUS CONTACTER</a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Liberu-v2\cms-laravel\resources\views/courtage-travaux.blade.php ENDPATH**/ ?>