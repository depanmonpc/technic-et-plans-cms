...
<section class="wa">
    <div class="wa__head">
        ...
        <!--[if BLOCK]><![endif]--><?php if(Route::has('articles.index')): ?>
            <a class="wa__cta" href="<?php echo e(route('articles.index')); ?>">Voir tous les articles</a>
    ...
    <div class="wa__grid">
        ...
        <article class="wa__card wa__card--hero">
            <a class="wa__link" href="<?php echo e(route('articles.show', $featured->slug)); ?>">
                <figure class="wa__media">
                    <!--[if BLOCK]><![endif]--><?php if($featured->thumbnail): ?>
                    ...
                    <figcaption class="wa__date">
                        <span><?php echo e(optional($featured->published_at)->translatedFormat('d')); ?></span>
                        <small><?php echo e(optional($featured->published_at)->translatedFormat('M Y')); ?></small>
                    </figcaption>
                    <!--[if BLOCK]><![endif]--><?php if(optional($featured->published_at)->gt(now()->subDays(7))): ?>
                ...
                <div class="wa__content">
                    <h3 class="wa__title wa__title--hero">
                        <?php echo e(\Illuminate\Support\Str::limit($featured->title, 110)); ?>

                    </h3>
                    <?php
                        $fx = $featured->excerpt ?? \Illuminate\Support\Str::limit(strip_tags($featured->content ?? ''), 220);
                    ?>
                    <!--[if BLOCK]><![endif]--><?php if($fx): ?>
                        <p class="wa__excerpt wa__excerpt--hero">
                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($fx), 180)); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <article class="wa__card wa__card--small">
            <a class="wa__link" href="<?php echo e(route('articles.show', $article->slug)); ?>">
                <figure class="wa__media">
                    <!--[if BLOCK]><![endif]--><?php if($article->thumbnail): ?>
                    ...
                    <div class="wa__overlay"></div>
                    <figcaption class="wa__date">
                        <span><?php echo e(optional($article->published_at)->translatedFormat('d')); ?></span>
                        <small><?php echo e(optional($article->published_at)->translatedFormat('M Y')); ?></small>
                    </figcaption>
                    <!--[if BLOCK]><![endif]--><?php if(optional($article->published_at)->gt(now()->subDays(7))): ?>
                        <div class="wa__ribbon">Nouveau</div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </figure>

                <div class="wa__content">
                    <h3 class="wa__title"><?php echo e(\Illuminate\Support\Str::limit($article->title, 85)); ?></h3>
                    <?php
                        $ex = $article->excerpt ?? \Illuminate\Support\Str::limit(strip_tags($article->content ?? ''), 160);
                    ?>
                    <!--[if BLOCK]><![endif]--><?php if($ex): ?>
                        <p class="wa__excerpt"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($ex), 110)); ?></p>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
