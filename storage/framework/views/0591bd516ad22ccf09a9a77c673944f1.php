    ...
    <header class="header">
        <div class="content">
            ...
            <div class="header-menu">
                <a href="<?php echo e(url('index.php')); ?>" class="header-menu-item<?php echo e(($pageName ?? '') == 'index' ? ' header-menu-item-active' : ''); ?>">ACCUEIL</a>
                <a href="<?php echo e(url('notre-savoir-faire.php')); ?>" class="header-menu-item<?php echo e(($pageName ?? '') == 'notre-savoir-faire' ? ' header-menu-item-active' : ''); ?>">NOTRE SAVOIR FAIRE</a>
                <a href="<?php echo e(url('courtage-travaux.php')); ?>" class="header-menu-item<?php echo e(($pageName ?? '') == 'courtage-travaux' ? ' header-menu-item-active' : ''); ?>">COURTAGE TRAVAUX</a>
                <a href="<?php echo e(url('contact.php')); ?>" class="header-menu-item<?php echo e(($pageName ?? '') == 'contact' ? ' header-menu-item-active' : ''); ?>">CONTACT</a>
            </div>
