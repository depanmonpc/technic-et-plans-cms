...
<?php $__env->startSection('title', 'Notre savoir-faire'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="index-four">
        <div class="content">
            ...
            <div class="index-four-links">
                <a href="<?php echo e($nsf('etude')); ?>"
                   class="index-four-link <?php echo e($p==='etude' ? 'is-active' : ''); ?>"
                   id="index-four-link-1">ÉTUDE D’AVANT PROJET</a>

                <a href="<?php echo e($nsf('permis')); ?>"
                   class="index-four-link <?php echo e($p==='permis' ? 'is-active' : ''); ?>"
                   id="index-four-link-2">PERMIS DE CONSTRUIRE</a>

                <a href="<?php echo e($nsf('projet')); ?>"
                   class="index-four-link <?php echo e($p==='projet' ? 'is-active' : ''); ?>"
                   id="index-four-link-3">PROJET D’EXTENSION OU D’AMÉNAGEMENT</a>

                <a href="<?php echo e($nsf('perspective')); ?>"
                   class="index-four-link <?php echo e($p==='perspective' ? 'is-active' : ''); ?>"
                   id="index-four-link-4">PERSPECTIVE & VUE INTÉRIEURE</a>
            </div>

            <div class="index-four-thumbs">
                <div class="index-four-thumb">
                    <img src="<?php echo e(asset('asset/img/thumb-1.jpg')); ?>" alt=""><span></span>
                </div>
                <div class="index-four-thumb">
                    <img src="<?php echo e(asset('asset/img/thumb-2.jpg')); ?>" alt=""><span></span>
                </div>
                <div class="index-four-thumb">
                    <img src="<?php echo e(asset('asset/img/thumb-3.jpg')); ?>" alt=""><span></span>
                </div>
                <div class="clear"></div>
            </div>
        </div>
    ...
    <div class="competences" id="competences-1">
        <div class="content">
            ...
            <a href="<?php echo e(asset('asset/img/exemple-big-9.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-9.jpg')); ?>" alt="" class="competences-img competences-img-1">
            </a>
            <a href="<?php echo e(asset('asset/img/exemple-big-10.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-10.jpg')); ?>" alt="" class="competences-img competences-img-2">
            </a>
            <a href="<?php echo e(asset('asset/img/exemple-big-11.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-11.jpg')); ?>" alt="" class="competences-img competences-img-3">
            </a>
            <a href="<?php echo e(asset('asset/img/exemple-big-12.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-12.jpg')); ?>" alt="" class="competences-img competences-img-4">
            </a>

            <img src="<?php echo e(asset('asset/img/show-image.jpg')); ?>" alt="Cliquez pour agrandir la photo" class="competences-extend">
        </div>
    </div>
    ...
    <div class="competences" id="competences-2" style="height:1200px;">
        <div class="demarches">
            <div class="content">
                ...
                <img src="<?php echo e(asset('asset/img/etapes.jpg')); ?>" alt="Mise en conformité de votre projet..." class="demarches-image">

                <div class="grid-diapo">
                    <?php for($i = 1; $i <= 8; $i++): ?>
                        <a href="<?php echo e(asset("asset/img/0$i.jpg")); ?>" class="manific-image">
                            <img src="<?php echo e(asset("asset/img/0$i.jpg")); ?>" alt="">
                        </a>
                    <?php endfor; ?>
                    <div class="clear"></div>
                </div>
        ...
        <div class="demarches-two">
            <div class="content">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="demarches-two-btn">CONTACTER TECHNIC & PLANS</a>
                <img src="<?php echo e(asset('asset/img/home.png')); ?>" alt="Maison" class="demarches-two-image">
            </div>
        </div>
    </div>
    ...
    <div class="competences" id="competences-3">
        <div class="content">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="competences-btn competences-btn-3">CONTACTEZ TECHNIC ET PLANS</a>

            <div class="competences-text-vertical">EXEMPLES DE RÉALISATIONS</div>

            <a href="<?php echo e(asset('asset/img/exemple-big-5.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-5.jpg')); ?>" alt="" class="competences-img competences-img-1">
            </a>
            <a href="<?php echo e(asset('asset/img/exemple-big-6.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-6.jpg')); ?>" alt="" class="competences-img competences-img-2">
            </a>
            <a href="<?php echo e(asset('asset/img/exemple-big-7.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-7.jpg')); ?>" alt="" class="competences-img competences-img-3">
            </a>
            <a href="<?php echo e(asset('asset/img/exemple-big-8.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-8.jpg')); ?>" alt="" class="competences-img competences-img-4">
            </a>
    ...
    <div class="competences" id="competences-4">
        <div class="content">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="competences-btn competences-btn-4">CONTACTEZ TECHNIC ET PLANS</a>

            <div class="competences-text-vertical">EXEMPLES DE RÉALISATIONS</div>

            <a href="<?php echo e(asset('asset/img/exemple-big-1.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-1.jpg')); ?>" alt="" class="competences-img competences-img-1">
            </a>
            <a href="<?php echo e(asset('asset/img/exemple-big-2.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-2.jpg')); ?>" alt="" class="competences-img competences-img-2">
            </a>
            <a href="<?php echo e(asset('asset/img/exemple-big-3.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-3.jpg')); ?>" alt="" class="competences-img competences-img-3">
            </a>
            <a href="<?php echo e(asset('asset/img/exemple-big-4.jpg')); ?>" class="manific-image">
                <img src="<?php echo e(asset('asset/img/exemple-4.jpg')); ?>" alt="" class="competences-img competences-img-4">
            </a>
    ...
    <div class="demarches-three" id="demarches-three">
        <div class="content">
            ...
            <img src="<?php echo e(asset('asset/img/cabinet-et-bureau.jpg')); ?>" alt="Cabinet d'architecture et Bureau d'étude thermique" class="demarches-three-image">
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Liberu-v2\cms-laravel\resources\views/notre-savoir-faire.blade.php ENDPATH**/ ?>